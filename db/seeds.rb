...
c1 = Candidate.create!(name: "Johnny John", position: "CTO au Wagon", user_id: u.id, job_offer_id: j1.id, email: "johnny@lewagon.org")
c2 = Candidate.create!(name: "Marc Jones", position: "Data Scientist", user_id: u2.id, job_offer_id: j2.id, email: "marc_jones@gmail.com")
c3 = Candidate.create!(name: "Francky Freddy", position: "Sales Director", user_id: u5.id, job_offer_id: j3.id, email: "francky@gmail.com")
